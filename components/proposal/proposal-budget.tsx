...
import { ArrowRight, Check, Compass, LineChart, Plus, Video, FileText } from "lucide-react";
    ...
    <section className="border-t border-white/10 bg-black px-6 py-24 text-white lg:px-12 lg:py-32">
      ...
      >
        <p className="font-display text-6xl tabular-nums text-white sm:text-7xl">
          {currency.format(content.heroNumber)}
          <span className="ml-1 font-mono text-lg text-white/35">/mês</span>
        </p>
