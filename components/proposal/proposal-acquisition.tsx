...
import type { AcquisitionCard } from "@/lib/clients/proposal-types";

/**
 * "Estratégia de aquisição" — 4 cards conectados (Prospecção ativa → Patrocínio → Parcerias →
 * Crescimento), mesma interação de expandir da ProposalPillars (hover no desktop, clique em
 * qualquer dispositivo). O card 04 (Crescimento) ganha um ícone de ciclo pra reforçar que a
 * aquisição realimenta o processo, em vez de terminar no primeiro contato.
 */
...
export function ProposalAcquisition({
  content,
  accent,
}: {
