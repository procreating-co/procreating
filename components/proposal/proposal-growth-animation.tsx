...
/**
 * Substitui o antigo bloco de texto "O próximo passo do nosso trabalho..." — visual, não
 * textual. Uma linha ascendente conecta 6 pontos (Estratégia → ... → Crescimento), desenhando-se
 * conforme entra na tela; cada nó pulsa em sequência. `viewport={{ once: true }}` garante que a
 * animação roda uma vez só, não toda vez que a seção reentra no viewport.
 */
export function ProposalGrowthAnimation({ content, accent }: { content: ProposalContent["growthAnimation"]; accent: string }) {
  return (
