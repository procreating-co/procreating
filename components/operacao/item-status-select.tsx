...
export function ItemStatusSelect({ itemId, kind, statusLabel }: { itemId: string; kind: ProductionItemKind; statusLabel: string }) {
    ...
    <select
      ...
      onChange={(e) => {
        ...
        startTransition(async () => {
          await updateProductionItemStatusAction(itemId, kind, preset.label, preset.tone);
          router.refresh();
        });
      }}
