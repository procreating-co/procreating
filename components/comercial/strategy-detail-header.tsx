...
export function StrategyDetailHeader({ strategy }: { strategy: Strategy }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <Link href="/comercial?tab=commercial&panel=strategies" className="flex w-fit items-center gap-1.5 text-sm text-muted-foreground transition-colors hover:text-foreground">
