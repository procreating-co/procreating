  ...
  return (
    <main className="mx-auto flex max-w-[1400px] flex-col gap-8 px-6 py-16 lg:px-10">
      <div className="flex flex-col gap-2">
        ...
        <p className="max-w-lg text-sm text-muted-foreground">Todas as suas tarefas, de qualquer prazo — My Day mostra só o que vence hoje ou está atrasado.</p>
      </div>
